...
defineProps(
  getSliceComponentProps<Content.SkillSlice>([
    "slice",
    "index",
    "slices",
    "context",
...
<template>
  ...
  >
    <div class="px-[6%] xl:px-[10%] flex flex-col gap-20 py-16 lg:py-32 bg-[#221F28]">
      <div class="flex flex-col gap-6 lg:gap-10">
        <div class="flex flex-col gap-2 lg:gap-4">
          ...
          <PrismicRichText :field="slice.primary.content" class="text-light-200 text-sm lg:text-xl lg:max-w-[1000px]"/>
        </div>
      </div>
      <div class="grid grid-cols-1 gap-4 text-light-100 lg:grid-cols-2 lg:gap-16">
